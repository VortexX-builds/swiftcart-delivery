        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              id="cart-button"
              onClick={onCartClick}
              className="relative flex items-center gap-2 bg-brand text-white px-4 py-2 rounded-xl text-sm font-semibold hover:bg-brand-dark active:scale-95 transition-all duration-200 shadow-md shadow-brand/20"
            >
            ...
            {session ? (
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-2 rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors duration-200"
                >
                  {profile?.avatar_url ? (
                    <img 
              ...
              <Link
                to="/login"
                className="flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-semibold text-gray-700 hover:bg-gray-100 active:scale-95 transition-all duration-200"
              >
